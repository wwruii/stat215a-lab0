...
1. If you have already set up your Github account, clone my stat-215-a-gsi repo by typing in the terminal (`git clone https://github.com/OmerRonen/stat-215-a-gsi`) to get the class materials and data for this lab. These will live in the `lab0/` folder. If you have already cloned this repo, you can instead just pull any changes from the stat-215-a-gsi github repo (`git pull`).
